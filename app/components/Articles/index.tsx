...
const postData: DataType[] = [
    {
        time: "5 min",
        heading: 'Nuestra nueva plataforma',
        heading2: 'Ya está disponible para ti',
        name: "Publicado en Startupon",
        date: '19 de agosto de 2021',
        imgSrc: '/images/articles/cat.gif',
    },
    {
        time: "5 min",
        heading: 'Nuestra nueva plataforma',
        ...
        name: "Publicado en Startupon",
        date: '19 de agosto de 2021',
        imgSrc: '/images/articles/cat-vibing.gif',
    },
...
export default class MultipleItems extends Component {
    ...
    <h3 className="text-blue text-lg font-normal tracking-widest">Blog</h3>
    <h3 className="text-4xl sm:text-6xl font-bold">Nuestro último post.</h3>
</div>
                        ...
                        {postData.map((items, i) => (
                            <div key={i} >
                                ...
                                <div className='bg-white m-3 px-3 pt-3 pb-12 my-10 shadow-lg rounded-3xl relative'>
                                    <Image src={items.imgSrc} alt="gaby" width={229} height={202} className="inline-block m-auto" />
