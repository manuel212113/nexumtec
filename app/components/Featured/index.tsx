...
const postData: DataType[] = [
    {
        heading: 'Aplicación 1',
        imgSrc: '/images/featured/feat1.jpg',
    },
    {
        heading: 'Aplicación 2',
        imgSrc: '/images/featured/feat2.jpg',
    },
    {
        heading: 'Aplicación 3',
        imgSrc: '/images/featured/feat1.jpg',
    },
    {
        heading: 'Aplicación 4',
        imgSrc: '/images/featured/feat2.jpg',
    }
];
...
export default class MultipleItems extends Component {
    ...
    <h3 className="text-4xl sm:text-6xl font-bold text-white my-2">Trabajos destacados.</h3>
    <h3 className="text-4xl sm:text-6xl font-bold text-white text-opacity-50 lg:mr-48 my-2">Trabajos destacados.</h3>
    <h3 className="text-4xl sm:text-6xl font-bold text-white text-opacity-25 lg:-mr-32 my-2">Trabajos destacados.</h3>
</div>
