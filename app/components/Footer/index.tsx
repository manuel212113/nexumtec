...
const products: ProductType[] = [
    {
        id: 1,
        section: "Menú",
        link: ['Inicio', 'Populares', 'Nosotros', 'Contacto'],
    },
    {
        id: 2,
        section: "Categorías",
        link: ['Blog', 'Trabajos Destacados', 'Ver Todo', 'Iniciar Sesión']
    },
    {
        id: 3,
        section: "Páginas",
        link: ['404', 'Instrucciones', 'Licencia']
    },
    {
        id: 4,
        section: "Otros",
        link: ['Guía de Estilo', 'Registro de Cambios']
    }
];
...
const footer = () => {
    return (
        <div className="bg-darklogo -mt-40" id="first-section">
            <div className="mx-auto max-w-2xl pt-48 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4'>
                        <Image src="/images/banner/logo_pequeño_blanco.png" alt="gaby" width={170} height={120}  />                                
            ...
            <div className="mx-auto max-w-2xl lg:max-w-7xl">
                <div className="pt-5 pb-5 px-4 sm:px-6 lg:px-4 border-solid border-t border-footer">
                    <div className="mt-4 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 xl:gap-x-8">
                        <div>
                            <h3 className='text-center md:text-start text-offwhite text-lg'>@2025 - All Rights Reserved by <Link href="https://google.com/" target="_blank"> Nexum</Link></h3>
                        </div>
